...
SAVE_DIR = '/mnt/storage/bb_echopdf_figs/echopdfmodel_with_without_noise';
...
save([ds.SAVE_DIR,'/echopdfmodel_wnoise_N10_50.mat'],'pm','pmx','N','s_all','ds');
wnoise_N10_50_f = 'echopdfmodel_wnoise_N10_50.mat';
...
loglog(raylx,nrayl2,'k-','linewidth',1.5);
...
wnoise_N100to1000 = load([SAVE_DIR,'/',wnoise_N100to1000_f]);
wnoise_N10_50 = load([SAVE_DIR,'/',wnoise_N10_50_f]);
...
loglog(wnoise_N10_50.pmx,wnoise_N10_50.pm(:,1),'k--','linewidth',3);
xlabel('Normazlied echo amplitude','fontsize',12);
ylabel('PDF','fontsize',12);
set(gca,'fontsize',10);
...
loglog(wnoise_N10_50.pmx,wnoise_N10_50.pm(:,2),'k--','linewidth',3);
xlabel('Normazlied echo amplitude','fontsize',12);
ylabel('PDF','fontsize',12);
set(gca,'fontsize',10);
axis([5e-3 50 1e-5 1e2]);
...
loglog(wnoise_N100to1000.pmx,wnoise_N100to1000.pm(:,1),'k--','linewidth',3);
xlabel('Normazlied echo amplitude','fontsize',12);
ylabel('PDF','fontsize',12);
set(gca,'fontsize',10);
axis([5e-3 50 1e-5 1e2]);
...
loglog(wnoise_N100to1000.pmx,wnoise_N100to1000.pm(:,5),'k--','linewidth',3);
xlabel('Normazlied echo amplitude','fontsize',12);
ylabel('PDF','fontsize',12);
set(gca,'fontsize',10);
axis([5e-3 50 1e-5 1e2]);
