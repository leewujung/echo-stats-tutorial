...
function bbechopdf_20141124(N,mix_r,ns,gate_len,tx,sdir,fname,bpa,indiv,varargin)
%INPUT
...
if nargin>9
    ...
    elseif indiv==2
        ...
        if nargin>=10
            % --- aspect ratio and length distribution ---
            ...
            else  % if no specified aspect ratio and angle distribution
    ...
    elseif indiv==1 | indiv==3
        ...
        if nargin<11
            ...
            % --- broadband or narrowband fish response ---
            if indiv==1
