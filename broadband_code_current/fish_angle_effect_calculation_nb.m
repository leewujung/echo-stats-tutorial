...
tx = 3;
%sdir = '/mnt/storage/ECHO_STAT/20130807_fish_nb_resp';
sdir = '/mnt/storage/ECHO_STAT/20130807_fish_nb_resp_unif_angle_distr';
...
% Fish, 22cm only
model_n_scat_freqdep_bp_mixed_freqdomain_wfish_nb(N(iN),mix_r,ns, ...
         glen,tx,taper,save_opt,sdir,'fish_len22_unif-5to5_nb40e3',...
         [],3,[0.22,1],[0,5],40e3);
%model_n_scat_freqdep_bp_mixed_freqdomain_wfish_nb(N,mix_r,ns,...
%        gate_len,tx,taper,sopt,sdir,fname,...
%        bpa,indiv,[len_bin,len_dist],[angle_mean,angle_std],nb_freq)


model_n_scat_freqdep_bp_mixed_freqdomain_wfish_nb(N(iN),mix_r,ns, ...
         glen,tx,taper,save_opt,sdir,'fish_len22_mean0_std40_nb50e3',...
         [],3,[0.22,1],[0,40],50e3);
model_n_scat_freqdep_bp_mixed_freqdomain_wfish_nb(N(iN),mix_r,ns, ...
         glen,tx,taper,save_opt,sdir,'fish_len22_mean0_std40_nb60e3',...
         [],3,[0.22,1],[0,40],60e3);
model_n_scat_freqdep_bp_mixed_freqdomain_wfish_nb(N(iN),mix_r,ns, ...
         glen,tx,taper,save_opt,sdir,'fish_len22_mean0_std40_nb40e3',...
         [],3,[0.22,1],[0,40],40e3);
