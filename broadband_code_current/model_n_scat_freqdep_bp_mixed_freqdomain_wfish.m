...
function model_n_scat_freqdep_bp_mixed_freqdomain_wfish(N,mix_r,ns,gate_len,tx,taper,sopt,sdir,fname,bpa,indiv,varargin)
%INPUT
...
%               if indiv=1: {len_bin,len_dist,angle_mean,angle_std}
%                           len unit: m, angle unit: deg
...
parfor iS=1:ns  % realization loop
    ...
    elseif indiv==1  % fish scattering response
